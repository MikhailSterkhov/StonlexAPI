package ru.stonlex.bukkit.particle;
...
import ru.stonlex.bukkit.utility.WrapperUtil;
...
public enum ParticleEffect {
    ...
    public static final class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                version = Integer.parseInt(Character.toString(WrapperUtil.VERSION.charAt(3)));
                if (version > 7) {
                    enumParticle = Class.forName("net.minecraft.server." + WrapperUtil.VERSION + ".EnumParticle");
                }
                Class<?> packetClass = Class.forName(version < 7 ? "net.minecraft.server." + WrapperUtil.VERSION + ".Packet63WorldParticles" : "net.minecraft.server." + WrapperUtil.VERSION + ".PacketPlayOutWorldParticles");
                packetConstructor = ReflectionUtil.getConstructor(packetClass);
                getHandle = ReflectionUtil.getMethod(Class.forName("org.bukkit.craftbukkit." + WrapperUtil.VERSION + ".entity.CraftPlayer"), "getHandle");
                playerConnection = ReflectionUtil.getField(Class.forName("net.minecraft.server." + WrapperUtil.VERSION + ".EntityPlayer"), false, "playerConnection");
                sendPacket = ReflectionUtil.getMethod(playerConnection.getType(), "sendPacket", Class.forName("net.minecraft.server." + WrapperUtil.VERSION + ".Packet"));
