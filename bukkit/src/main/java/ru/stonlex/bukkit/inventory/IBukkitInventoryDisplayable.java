...
public interface IBukkitInventoryDisplayable {
     ...
     */
    void setItem(int buttonSlot, IBukkitInventoryButton inventoryButton);
     ...
     */
    TIntObjectMap<IBukkitInventoryButton> getButtons();
