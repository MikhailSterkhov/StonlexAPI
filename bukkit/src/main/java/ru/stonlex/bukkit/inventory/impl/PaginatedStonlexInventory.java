...
@Getter
public abstract class PaginatedStonlexInventory implements IPaginatedBukkitInventory {
    ...
    private final TIntObjectMap<IBukkitInventoryButton> buttons = new TIntObjectHashMap<>();

    protected final List<Integer> pageSlots = new LinkedList<>();
    protected final List<IBukkitInventoryButton> pageButtons = new LinkedList<>();


    protected IBukkitInventoryUpdater inventoryUpdater;
    protected IPaginatedBukkitInventorySortable inventorySort;
     ...
     */
    public PaginatedStonlexInventory(String inventoryTitle, int inventoryRows) {
    ...
    @Override
    public void setInventorySort(@NonNull IPaginatedBukkitInventorySortable inventorySort) {
    ...
    @Override
    public void addItemToMarkup(@NonNull IBukkitInventoryButton inventoryButton) {
