...
import ru.stonlex.bukkit.module.protocol.packet.entity.WrapperPlayServerNamedEntitySpawn;
import ru.stonlex.bukkit.module.protocol.packet.entity.WrapperPlayServerPlayerInfo;
...
public class FakePlayer extends StonlexFakeEntity {
    ...
    public void sendSpawnPacket(Player player) {
        ...
        }.runTaskLater(BukkitAPI.getInstance(), 20);
    }
