package ru.stonlex.bukkit.protocol.messaging.packet.manager;
...
import ru.stonlex.bukkit.protocol.messaging.reference.ProtocolReference;
...
public final class PacketManager {
    ...
    public void sendPacket(MessagingPacket messagingPacket) {
        Plugin plugin = BukkitAPI.getPlugin(BukkitAPI.class);
